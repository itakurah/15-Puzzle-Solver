...
/**
 * Class for testing the manhattan distance heuristic with IDA*
 */
public class IDAStarManhattanDistanceTest {
    /**
    ...
    void testManhattan() {
        for (int i = 1; i < 54; i++) {
            ...
            for (Board b : boardList) {
                Result result = IDAStar.solve(b, new ManhattanDistance(), TimeUnit.NS, DebugMode.ON);
