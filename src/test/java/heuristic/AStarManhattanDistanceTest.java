...
/**
 * Class for testing the manhattan distance heuristic with A*
 */
public class AStarManhattanDistanceTest {
    /**
    ...
    void testManhattan() {
        for (int i = 1; i < 38; i++) {
            ...
            for (Board b : boardList) {
                Result result = AStar.solve(b, new ManhattanDistance(), TimeUnit.NS, DebugMode.ON);
