...
/**
 * Class for testing the combined linear conflict with manhattan distance heuristic with A*
 */
public class AStarLinearConflictMDistanceTest {
    /**
    ...
    void testLinear() {
        for (int i = 1; i < 42; i++) {
            ...
            for (Board b : boardList) {
                Result result = AStar.solve(b, new LinearConflictWithMD(), TimeUnit.NS, DebugMode.ON);
