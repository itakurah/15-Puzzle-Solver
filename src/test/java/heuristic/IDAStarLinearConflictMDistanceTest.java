...
/**
 * Class for testing the combined linear conflict with manhattan distance heuristic with IDA*
 */
public class IDAStarLinearConflictMDistanceTest {
    /**
    ...
    void testLinear() {
        for (int i = 1; i < 54; i++) {
            ...
            for (Board b : boardList) {
                Result result = IDAStar.solve(b, new LinearConflictWithMD(), TimeUnit.NS, DebugMode.ON);
