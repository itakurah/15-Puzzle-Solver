...
/**
 * Class for testing the hamming distance heuristic with A*
 */
public class AStarHammingDistanceTest {
    /**
    ...
    void testHamming() {
        for (int i = 1; i < 30; i++) {
            ...
            for (Board b : boardList) {
                Result result = AStar.solve(b, new HammingDistance(), TimeUnit.NS, DebugMode.ON);
